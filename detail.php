...
$database = $toolbox->getDatabaseAdapter();
	...
	$newsid = $_GET["id"];
	$article = R::findOne("article", "id=".$newsid);		
...
<div class="post">
	...
	<a href="handleUpdate.php?updateID=<?php echo $article->id; ?>">Update</a><a href="handleDelete.php?deleteID=<?php echo $article->id; ?>">Delete</a>
